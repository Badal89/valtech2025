...
public class HibernateClient {
           public static void main(String[] args) {
			SessionFactory sesFac= new AnnotationConfiguration()
				...
				.addAnnotatedClass(Tx.class).addAnnotatedClass(CheckTx.class).addAnnotatedClass(TellerTx.class)
...
//			ses.save(new CheckTx(2000,123456));
...
//			ses.update(car);
//			ses.flush();//pls do not call session on flush on your own..
//		    System.out.println(car);
